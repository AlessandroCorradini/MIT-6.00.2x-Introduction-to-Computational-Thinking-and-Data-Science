# Consider once again our permutations of students in a line. Recall the nodes in the graph
# represent permutations, and that the edges represent swaps of adjacent students. 
# We want to design a weighted graph, weighting edges higher for moves that are harder to make. 
# Which of these could be easily implemented by simply assigning weights to the edges already 
# in the graph?


# A) A large student who is difficult to move around in line. [X]
# B) A sticky spot on the floor which is difficult to move onto and off of. [X]
