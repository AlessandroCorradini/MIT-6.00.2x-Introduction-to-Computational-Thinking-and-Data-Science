...
# Hint: You might want to use bin() on an int to get a string, get rid of the first two 
# characters, add leading 0's as needed, and then convert it to a numpy array of ints. 
# Type help(bin) in the console.
